...
*/
public class QwirkleComputerPlayer2 extends QwirkleComputerPlayer1 {
	...
	private QwirkleState currentGameState = null;
	...
	protected void receiveInfo(GameInfo info) {
		...
		else if (info instanceof QwirkleState) {
			// if we indeed have a counter-state, update the GUI
			currentGameState = (QwirkleState)info;
			updateDisplay();
		}
	}
